...
def main(args):
    ...
    print("\n" + "="*50)
    print("🏆 FINAL EVALUATION METRICS (IIW GENERATOR - TCN_cVAE_MoE) 🏆")
    print("="*50)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weights_path', type=str, default='/home/song/reserch/iiw/proposed/TCN_cVAE_MoE/weights/best.pth', help='Path to best trained weights')
