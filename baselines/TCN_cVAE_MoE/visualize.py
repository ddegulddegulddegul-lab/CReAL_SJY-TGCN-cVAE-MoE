...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("Visualize TCN IIW Model")
    parser.add_argument("--data_dir", type=str, default="./data/", help="Folder containing .npz sequences")
    parser.add_argument("--weights_path", type=str, default="./baselines/TCN_cVAE_MoE/weights/best.pth", help="Path to trained model weights")
