...
def main(args):
    ...
    print(f"--- Training Baseline MLP-cVAE+MoE ---")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', type=str, default='./baselines/MLP_cVAE_MoE/weights', help='Directory to save model weights')
