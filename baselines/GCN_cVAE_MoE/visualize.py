...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("Visualize GCN IIW Model")
    parser.add_argument("--data_dir", type=str, default="./data/", help="Folder containing .npz sequences")
    parser.add_argument("--weights_path", type=str, default="./baselines/GCN_cVAE_MoE/weights/best.pth", help="Path to trained model weights")
