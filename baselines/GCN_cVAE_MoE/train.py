...
def main(args):
    ...
    print(f"--- Training Baseline GCN-cVAE+MoE ---")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train Baseline GCN Model")
    parser.add_argument('--mmap_path', type=str, default='./dataset_mmap.npy', help='Path to combined memmap data')
    parser.add_argument('--save_dir', type=str, default='./baselines/GCN_cVAE_MoE/weights', help='Directory to save model weights')
