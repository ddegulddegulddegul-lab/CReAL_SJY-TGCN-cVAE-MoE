...
class TGCNEncoder(nn.Module):
    def __init__(self, node_in_dim=9, ray_in_dim=3, hidden_dim=64, z_dim=32, num_joints=15, num_rays=540):
...
class IIWTGCN_cVAE(nn.Module):
    def __init__(self, node_in_dim=9, ray_in_dim=3, hidden_dim=64, z_dim=32, num_body_parts=6, num_experts=3):
